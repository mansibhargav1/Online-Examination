...
//=======================================================================================================
		if(e.getSource()==lg.b1)
		{
			...
			ResultSet rs=st.executeQuery("select * from regis where name='"+s1+"' AND pass='"+s2+"' AND verify='verfied'");
			if(rs.next())
			{
				card.show(cn,"intro");
...
class Demo
{
	public static void main(String ar[])
	{
		...
		f.setTitle("Online Exam Software");
		f.setDefaultCloseOperation(f.EXIT_ON_CLOSE);
	}
}
// C:\Users\win 10\Videos\Captures